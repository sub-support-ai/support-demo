...
class CatalogItem:
    ...
    def question_for(self, field_name: str) -> str:
        return self.field_questions.get(
            field_name, FIELD_QUESTIONS.get(field_name, f"Укажите {field_name}.")
        )
...
CATALOG: list[CatalogItem] = [
    ...
    CatalogItem(
        ...
        trigger_terms=(
            ...
            "забыл пароль",
            "не могу войти",
            "заблокировали учётку",
            "заблокирована учетка",
