...
SUPPORT_DRAFT_INTENT_TERMS = (
    "тикет", "заявк", "черновик", "обращен", "запрос", "техподдерж",
    "тех поддерж", "специалист", "саппорт", "support",
)
...
KB_FAILED_FOLLOWUP_TERMS = (
    "не помог", "не поможет", "не сработ", "не получилось", "не подходит",
    "это не то", "не то", "бесполезно", "всё еще", "все еще", "по-прежнему",
    "ничего не изменилось", "та же ошибка", "осталось",
)
SUPPORT_HANDOFF_TERMS = (
    "надо менять", "нужно менять", "нужно заменить", "надо заменить",
    "заменить", "замена", "сгорел", "сгорела", "сломался", "сломалась",
    "сломано", "физически", "мастер", "специалист", "пусть придут",
    "передай", "оформи", "создай запрос", "заявку",
)
SUPPORT_OBJECT_TERMS = (
    "монитор", "экран", "ноутбук", "компьютер", "системный блок", "мыш",
    "клавиатур", "принтер", "мфу", "сканер", "док-станц", "гарнитур",
    "камера", "кабель", "провод", "зарядк", "блок питания", "оборудован",
)
