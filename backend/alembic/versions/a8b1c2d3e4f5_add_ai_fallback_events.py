...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_ai_fallback_events_id"), "ai_fallback_events", ["id"], unique=False)
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_ai_fallback_events_conversation_id"), table_name="ai_fallback_events")
