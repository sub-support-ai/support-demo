...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_knowledge_embedding_jobs_id"), "knowledge_embedding_jobs", ["id"], unique=False)
    op.create_index(
    ...
    op.create_index(op.f("ix_knowledge_embedding_jobs_status"), "knowledge_embedding_jobs", ["status"], unique=False)
    op.create_index(
...
def downgrade() -> None:
    op.drop_index("ix_knowledge_embedding_jobs_status_run_after_id", table_name="knowledge_embedding_jobs")
    op.drop_index(op.f("ix_knowledge_embedding_jobs_run_after"), table_name="knowledge_embedding_jobs")
    op.drop_index(op.f("ix_knowledge_embedding_jobs_status"), table_name="knowledge_embedding_jobs")
    op.drop_index(op.f("ix_knowledge_embedding_jobs_requested_by_user_id"), table_name="knowledge_embedding_jobs")
    op.drop_index(op.f("ix_knowledge_embedding_jobs_article_id"), table_name="knowledge_embedding_jobs")
