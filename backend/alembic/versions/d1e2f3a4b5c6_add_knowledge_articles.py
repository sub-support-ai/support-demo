...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_knowledge_articles_department"), "knowledge_articles", ["department"], unique=False)
    op.create_index(op.f("ix_knowledge_articles_request_type"), "knowledge_articles", ["request_type"], unique=False)
    op.create_index(op.f("ix_knowledge_articles_title"), "knowledge_articles", ["title"], unique=False)
    op.create_index(op.f("ix_knowledge_articles_is_active"), "knowledge_articles", ["is_active"], unique=False)
