...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_ai_jobs_conversation_id"), "ai_jobs", ["conversation_id"], unique=False)
    ...
    op.create_index("ix_ai_jobs_status_run_after_id", "ai_jobs", ["status", "run_after", "id"], unique=False)
