...
EXTRA_CASES = [
    ...
    # Outlook
    {
        "query": "письма не уходят из исходящих в Outlook",
        "expected_title": "Outlook не отправляет или не получает почту",
    },
    {
        "query": "Outlook просит пароль снова и снова",
        "expected_title": "Outlook не отправляет или не получает почту",
    },
    {
    ...
    # Teams / Zoom
    {
        "query": "в Zoom меня не слышат, микрофон не работает",
        "expected_title": "Teams или Zoom: нет звука, камеры или подключения к встрече",
    },
    {
        "query": "Teams не подключается к встрече, бесконечная загрузка",
        "expected_title": "Teams или Zoom: нет звука, камеры или подключения к встрече",
    },
    {
        "query": "камера в Teams черная, собеседники меня не видят",
        "expected_title": "Teams или Zoom: нет звука, камеры или подключения к встрече",
    },
]
